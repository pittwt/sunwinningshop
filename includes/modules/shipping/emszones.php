...
// shipping adjustment
      ...
      if (strstr(MODULE_SHIPPING_EMSZONES_SKIPPED, $dest_country)) {
        ...
        if ($error == true) $this->quotes['error'] = MODULE_SHIPPING_EMSZONES_INVALID_ZONE;
      }
    ...
    function install() {
      global $db;
	 if (!defined('MODULE_SHIPPING_EMSZONES_TEXT_CONFIG_1_1')) include(DIR_FS_CATALOG_LANGUAGES . $_SESSION['language'] . '/modules/shipping/' . $this->code . '.php');
    ...
    function keys() {
      $keys = array('MODULE_SHIPPING_EMSZONES_STATUS', 'MODULE_SHIPPING_EMSZONES_METHOD', 'MODULE_SHIPPING_EMSZONES_TAX_CLASS', 'MODULE_SHIPPING_EMSZONES_TAX_BASIS', 'MODULE_SHIPPING_EMSZONES_SORT_ORDER', 'MODULE_SHIPPING_EMSZONES_SKIPPED');
