...
//  $products_image = $review->fields['products_image'];
  if ($review->fields['products_image'] == '' and PRODUCTS_IMAGE_NO_IMAGE_STATUS == '1') {
    $products_image = PRODUCTS_IMAGE_NO_IMAGE;
      ...
      $addition_image=$db->Execute("select products_image from products_addition_image where products_id =".(int)$_GET['products_id']." ");
    $products_image = $addition_image->fields['products_image'];
  }
