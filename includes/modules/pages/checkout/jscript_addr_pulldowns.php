...
<script language="javascript" type="text/javascript">
  ...
  function hasClass(element_obj,class_name) {
    return element_obj.className.match(new RegExp('(\\s|^)'+class_name+'(\\s|$)'));
  }
  

  function removeClass(element_obj,class_name) {
    if (hasClass(element_obj,class_name)) {
      var reg = new RegExp('(\\s|^)'+class_name+'(\\s|$)');
      element_obj.className=element_obj.className.replace(reg,' ');
    }
  }
  
  function displayStateDropdown(theForm) {
    removeClass(theForm.zone_id, 'hiddenField');
  }

  function displayStateDropdownShipping(theForm) {
    removeClass(theForm.zone_id_shipping, 'hiddenField');
  }
