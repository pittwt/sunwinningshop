...
if ((isset($_POST['action']) && ($_POST['action'] == 'submit')) || (isset($_POST['fec_change_address']) && ($_POST['fec_change_address'] == 'submit'))) {
      ...
      switch($addressType) {
        ...
        $_SESSION['payment'] = '';
				...
				if(isset($_POST['address_new']) && $_POST['address_new'] == 1) {
					...
					$_SESSION['new_billing_address'] = $db->Insert_ID();
				}
        ...
        $_SESSION['shipping'] = '';
				...
				if(isset($_POST['address_new']) && $_POST['address_new'] == 1) {
					...
					$_SESSION['new_shipping_address'] = $db->Insert_ID();
				}
