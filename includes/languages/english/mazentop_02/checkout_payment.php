...
define('NAVBAR_TITLE_2', 'Shipping Address/Shipping Method/Payment Method');
define('TEXT_COUNT_MIN', 'Sub-Total : ');
define('TEXT_COUNT_SHIPPING', 'Shipping Charges : ');
define('TEXT_COUNT_TOTAL', 'Grand Total : ');
