...
if ($current_page_base == 'featured_products') { $active = 'tab_active'; 
		...
		<li id="<?php echo $active;?>"><a href="index.php?main_page=featured_products"><?php echo TOP_MENU_FEATURED_PRODUCTS;?></a></li>
...
<div class="tools-nav-right"></div>
		...
		<div align="right" class="float-right td-languages">
    		...
    		<!--div class="languages-wrapper">
					...
					echo $content;?>
					<label class="float-right"><?php echo HEADER_LANGUAGES;?></label>
