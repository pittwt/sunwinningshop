 ...
 * @version $Id: collect_info.php 16931 2010-07-18 05:33:04Z ajeh $
 */
...
<style type="text/css">
#files_list .list{
  float:left; width:162px; height:192px; padding:5px; text-align:center;
  margin:0 5px 5px 0; border:1px solid #66CCFF;
}
#files_list .list img{
  
}
#files_list .list .delButton{
  display:block;
  border:0 none;
  background:url(images/cancel.gif) no-repeat 3px center;
  height:24px;
  line-height:24px;
...
#files_list .rows{
  clear:both;  border:1px solid #66CCFF; padding:5px; font-size:12px;
  margin-bottom:4px; 
}

#files_list .rows .delButton{
  border:0 none;
  background:url(images/cancel.gif) no-repeat 3px center;
  height:20px;
  line-height:20px;
  ...
  margin-left:5px;
          ...
          <tbody id="attachbodyhidden">
            <tr>
              ...
              <div id="files_list">
            <?php
			/*This is the place to show the picture finder:XIECHANGQUAN*/
            if (is_int ( strpos ( $pInfo->products_image, ',' ) )) {
              ...
              for($i = 0; $i < count ( $imgsrcs ); $i ++) {
                ...
                $imgsrcs_base[$i] = substr_replace(substr($imgsrcs[$i], 0, strrpos($imgsrcs[$i], '.')),'s/',0,2);
              ...
              if( $pInfo->products_image == ""){
                ...
                $imgsrc_image_base = substr_replace(substr($pInfo->products_image, 0, strrpos($pInfo->products_image, '.')),'s/',0,2);
