 ...
 * @version $Id: schinese.php 0000 2009-12-10 Jack $
 */
...
define('BOX_MODULES_DSF_SHIPPING', '4PX Shipping');
...
// admin activity log warnings
  ...
  define('WARNING_WELCOME_DISCOUNT_COUPON_EXPIRES_IN', '警告! 注册优惠券将在%s天后过期');
    define('TEXT_ACCESS_DENIED', 'Sorry, your security clearance does not allow you to access this resource. Please contact your site administrator if you believe this to be incorrect. Sorry for any inconvenience.');
  
  
  define('TEXT_MSG_NOUPLOAD_LARGE','WARNING ! Upload Failed');
  define('TEXT_MSG_UPLOAD_LARGE','Successful uploaded ');
